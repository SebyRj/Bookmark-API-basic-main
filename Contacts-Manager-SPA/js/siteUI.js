...
async function renderBookmarks() {
    ...
    if (bookmarks !== null) {
        ...
        renderError("Service introuvable1");
    }
}
async function renderBookmarksCat(category) {
    showWaitingGif();
    $("#actionTitle").text("Liste des favoris");
    $("#createBookmark").show();
    $("#abort").hide();
                ...
                <div class="bookmarkContainer">
                    <div class="bookmarkLayout">
                        <div style= "display:flex">
                            <img src = "${bookmark.Url}/favicon.ico" class = "urlImg">
    ...
    return $(`
     <div class="bookmarkRow" contact_id=${bookmark.Id}">
        <div class="bookmarkContainer noselect">
            <a href=${bookmark.Url} class="bookmarkLayout">
                <div >
                    <img src = "${bookmark.Url}/favicon.ico" class = "urlImg">
...
function updateDropDownMenu(categories) {
    ...
    $('.category').on("click", function () {
        ...
        renderBookmarksCat(selectedCategory);
    });
}
